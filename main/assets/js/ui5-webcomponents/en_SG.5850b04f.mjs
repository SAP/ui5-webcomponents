const a = "This file has been derived from Unicode Common Locale Data Repository (CLDR) files (http://cldr.unicode.org). See the copyright and permission notice in the Unicode-Data-Files-LICENSE.txt available at the same location as this file or visit http://www.unicode.org/copyright.html", e = "35.1.0", n = "2022-05-02T19:26:05.809Z", t = {
  aa: "Afar",
  ab: "Abkhazian",
  ace: "Achinese",
  ach: "Acoli",
...
export {
  ...
  P as plurals,
  G as rtl,
  s as scientificFormat,
  i as scripts,
  r as territories,
  v as timeData,
  m as timezoneNames,
  u as timezoneNamesFormats,
  g as units
};
