const a = "This file has been derived from Unicode Common Locale Data Repository (CLDR) files (http://cldr.unicode.org). See the copyright and permission notice in the Unicode-Data-Files-LICENSE.txt available at the same location as this file or visit http://www.unicode.org/copyright.html", e = "35.1.0", t = "2022-05-02T19:26:05.809Z", n = {
  ...
  Buhd: "buhid",
  Cakm: "chakma",
  Cans: "s\xEDl\xB7labes dels abor\xEDgens canadencs unificats",
  Cari: "cari\xE0",
  Cham: "cham",
  Cher: "cherokee",
  Cirt: "cirth",
  ...
  CC: "Illes Cocos",
  CD: "Congo - Kinshasa",
  "CD-alt-variant": "Congo (Rep\xFAblica Democr\xE0tica del Congo)",
  CF: "Rep\xFAblica Centreafricana",
  CG: "Congo - Brazzaville",
  "CG-alt-variant": "Congo (Rep\xFAblica del Congo)",
  CH: "Su\xEFssa",
  CI: "Costa d\u2019Ivori",
  "CI-alt-variant": "CI",
  CK: "Illes Cook",
  ...
  short: {
    ...
    "area-dunam": {
      displayName: "d\xFAnams",
      "unitPattern-count-one": "{0} d\xFAnam",
      "unitPattern-count-other": "{0} d\xFAnams"
    },
    "concentr-karat": {
      displayName: "ct",
