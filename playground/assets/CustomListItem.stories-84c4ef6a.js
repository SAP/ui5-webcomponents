import{x as l}from"./lit-element-c5a2b594.js";import{l as i}from"./if-defined-c29cffe1.js";import{o}from"./unsafe-html-0ddd83da.js";const u={type:{control:"select",options:["Inactive","Active","Detail","Navigation"]},default:{control:{type:"text"},table:{type:{summary:"Array<Node>"}}},deleteButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}}},f={package:"@ui5/webcomponents",tagName:"ui5-li-custom",showDefaultStoryOnly:!0},r={title:"Main/List/Custom List Item",component:"CustomListItem",argTypes:u},c=t=>l` <ui5-list>
    <ui5-li-custom
