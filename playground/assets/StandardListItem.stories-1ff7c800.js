import{x as d}from"./lit-element-c5a2b594.js";import{l as e}from"./if-defined-c29cffe1.js";import{o as n}from"./unsafe-html-0ddd83da.js";const r={additionalTextState:{control:"select",options:["None","Success","Warning","Error","Information"]},type:{control:"select",options:["Inactive","Active","Detail","Navigation"]},default:{control:{type:"text"},table:{type:{summary:"Array<Node>"}}},imageContent:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},deleteButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}}},$={package:"@ui5/webcomponents",tagName:"ui5-li",showDefaultStoryOnly:!0},c={title:"Main/List/Standard List Item",component:"StandardListItem",argTypes:r},l=t=>d` <ui5-list>
  <ui5-li
    icon="${e(t.icon)}"
