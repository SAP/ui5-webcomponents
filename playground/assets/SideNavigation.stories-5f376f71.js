...
${i()}`,e=c.bind({});e.args={default:`<ui5-side-navigation-item text="Home" icon="home"></ui5-side-navigation-item>
    ...
    <ui5-side-navigation-item slot="fixedItems" text="History" icon="history">
        <ui5-side-navigation-sub-item text="External Link" href="https://sap.com" target="_blank"></ui5-side-navigation-sub-item>
    </ui5-side-navigation-item>`};e.decorators=[v];e.parameters={docs:{story:{iframeHeight:"700px",inline:!1}}};const t=c.bind({});t.args={default:`<ui5-side-navigation-item text="Home" icon="home"></ui5-side-navigation-item>
    <ui5-side-navigation-item text="People" expanded icon="group">
        <ui5-side-navigation-sub-item text="From My Team"></ui5-side-navigation-sub-item>
    ...
    <ui5-side-navigation-item text="External Link" icon="chain-link" href="https://sap.com" target="_blank"></ui5-side-navigation-item>`,fixedItems:`<ui5-side-navigation-item slot="fixedItems" text="Useful Links" icon="chain-link"></ui5-side-navigation-item>
    <ui5-side-navigation-item slot="fixedItems" text="History" icon="history"></ui5-side-navigation-item>
    <ui5-side-navigation-item text="External Link" icon="chain-link" href="https://sap.com" target="_blank"></ui5-side-navigation-item>`};t.decorators=[v,i=>a(s||(s=f([`<style>
...
}`,...(u=(d=e.parameters)==null?void 0:d.docs)==null?void 0:u.source}}};var m,l,g;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`args => {
  return html\`
<ui5-side-navigation ?collapsed="\${ifDefined(args.collapsed)}">
    \${args.header ? unsafeHTML(args.header) : null}
    \${unsafeHTML(args.default)}
...
}`,...(g=(l=t.parameters)==null?void 0:l.docs)==null?void 0:g.source}}};const k=["Basic","ToolLayout"],T=Object.freeze(Object.defineProperty({__proto__:null,Basic:e,ToolLayout:t,__namedExportsOrder:k,default:y},Symbol.toStringTag,{value:"Module"}));export{T as C,I as c};
