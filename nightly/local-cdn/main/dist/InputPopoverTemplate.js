...
export default function InputPopoverTemplate() {
    return (_jsxs(_Fragment, { children: [this._effectiveShowSuggestions && this.Suggestions?.template.call(this, valueStateMessage, valueStateMessageInputIcon), this.hasValueStateMessage &&
