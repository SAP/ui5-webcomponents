...
export default function MessageStripTemplate() {
    return (_jsxs("div", { id: this._id, class: {
        ...
        }, role: "note", "aria-labelledby": this._id, children: [!this.shouldHideIcon &&
                _jsx("div", { class: "ui5-message-strip-icon-wrapper", "aria-hidden": "true", children: this.iconProvided ?
                        _jsx("slot", { name: "icon" })
                        :
                            _jsx(Icon, { name: standardIconName.call(this), class: "ui5-message-strip-icon" }) }), _jsx("span", { class: "ui5-hidden-text", children: this.hiddenText }), _jsx("span", { class: "ui5-message-strip-text", children: _jsx("slot", {}) }), !this.hideCloseButton &&
                _jsx(Button, { icon: decline, design: "Transparent", class: "ui5-message-strip-close-button", tooltip: this._closeButtonText, onClick: this._closeClick })] }));
}
