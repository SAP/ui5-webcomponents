                ...
                _jsx(TableHeaderCell, { id: "selection-cell", "aria-selected": this._isSelected, "aria-label": this._i18nSelection, "data-ui5-table-cell-fixed": true, "data-ui5-table-selection-component": true, children: !this._isMultiSelect ?
                        ...
                        :
                            this._shouldRenderClearAll ?
                                ...
                                :
                                    _jsx(CheckBox, { id: "selection-component", tabindex: -1, checked: this._isSelected, onChange: this._onSelectionChange, accessibleName: this._i18nRowSelector, title: this._isSelected ? this._i18nDeselectAllRows : this._i18nSelectAllRows }) }), this._visibleCells.map(cell => (_jsx("slot", { name: cell._individualSlot }, cell._individualSlot))), this._rowActionCount > 0 &&
