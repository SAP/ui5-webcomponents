...
export default function ListItemGroupTemplate(hooks) {
    ...
    return (_jsxs("ul", { role: "group", class: "ui5-group-li-root", onDragEnter: this._ondragenter, onDragOver: this._ondragover, onDrop: this._ondrop, onDragLeave: this._ondragleave, children: [this.hasHeader &&
                _jsx(ListItemGroupHeader, { focused: this.focused, part: "header", accessibleRole: ListItemAccessibleRole.Group, children: this.hasFormattedHeader ? _jsx("slot", { name: "header" }) : this.headerText }), items.call(this), _jsx(DropIndicator, { orientation: "Horizontal", ownerReference: this })] }));
}
