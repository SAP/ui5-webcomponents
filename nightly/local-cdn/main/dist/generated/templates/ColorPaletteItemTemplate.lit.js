...
function block0(context, tags, suffix) { return html `<div class="ui5-cp-item" style="${styleMap(this.styles.root)}" value="${ifDefined(this.value)}" tabindex="${ifDefined(this.forcedTabIndex)}" role="button" aria-label="${ifDefined(this.colorLabel)} - ${ifDefined(this.index)}: ${ifDefined(this.value)}" title="${ifDefined(this.colorLabel)} - ${ifDefined(this.index)}: ${ifDefined(this.value)}" ?disabled="${this._disabled}"></div>`; }
