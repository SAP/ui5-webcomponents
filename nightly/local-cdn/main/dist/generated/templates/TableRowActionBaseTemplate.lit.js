...
function block3(context, tags, suffix) { return suffix ? html `<${scopeTag("ui5-button", tags, suffix)} icon="${ifDefined(this._icon)}" text="${ifDefined(this._text)}" tooltip="${ifDefined(this._text)}" @click=${this._onActionClick} design="Transparent"></${scopeTag("ui5-button", tags, suffix)}>` : html `<ui5-button icon="${ifDefined(this._icon)}" text="${ifDefined(this._text)}" tooltip="${ifDefined(this._text)}" @click=${this._onActionClick} design="Transparent"></ui5-button>`; }
function block4(context, tags, suffix) { return suffix ? html `<${scopeTag("ui5-icon", tags, suffix)} name="${ifDefined(this._icon)}" tooltip="${ifDefined(this._text)}" design="Transparent"></${scopeTag("ui5-icon", tags, suffix)}>` : html `<ui5-icon name="${ifDefined(this._icon)}" tooltip="${ifDefined(this._text)}" design="Transparent"></ui5-icon>`; }
