...
export default function DynamicPageTitleTemplate() {
    return (_jsxs("div", { class: "ui5-dynamic-page-title-root", children: [_jsx("span", { class: "ui5-dynamic-page-title-focus-area", "data-sap-focus-ref": true, tabIndex: this._tabIndex, onKeyDown: this._onkeydown, onClick: this.onTitleClick, role: "button", "aria-expanded": this.forAriaExpanded, "aria-labelledby": this._ariaLabelledBy, "aria-describedby": `${this._id}-toggle-description` }), this.hasSnappedTitleOnMobile ?
