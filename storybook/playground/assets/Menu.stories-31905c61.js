...
<ui5-menu-item text="Exit" icon="journey-arrive"></ui5-menu-item>`};t.decorators=[e=>r(s||(s=u([`<ui5-button id="btnOpenBasic" class="samples-margin" end-icon="slim-arrow-down">Open Menu</ui5-button> <br/>
	`,`
	<script>
...
<ui5-menu-item text="Close"></ui5-menu-item>
<ui5-menu-item text="Preferences" icon="action-settings" starts-section=""></ui5-menu-item>
<ui5-menu-item text="Exit" icon="journey-arrive"></ui5-menu-item>`};n.decorators=[e=>r(c||(c=u([`<ui5-button id="btnOpenBasic" class="samples-margin" end-icon="slim-arrow-down">Open Menu</ui5-button> <br/>
	`,`
	<script>
		btnOpenBasic.addEventListener("click", function(event) {
...
<ui5-menu-item text="Close"></ui5-menu-item>
<ui5-menu-item text="Preferences" icon="action-settings" starts-section=""></ui5-menu-item>
<ui5-menu-item text="Exit" icon="journey-arrive" additional-text="Ctrl+X"></ui5-menu-item>`};i.decorators=[e=>r(d||(d=u([`<ui5-button id="btnOpenAdditionalText" class="samples-margin" end-icon="slim-arrow-down">Open Menu</ui5-button> <br/>
	`,`
	<script>
