import{x as u}from"./lit-element-c5a2b594.js";import{l as t}from"./if-defined-c29cffe1.js";import{o as c}from"./unsafe-html-0ddd83da.js";import{o as P}from"./ValueState-8914436d.js";import{I as _}from"./InputType-b43f8be5.js";const k={type:{control:"select",options:["Text","Email","Number","Password","Tel","URL","Search"]},valueState:{control:"select",options:["None","Positive","Critical","Negative","Information"]},default:{control:{type:"text"},table:{type:{summary:"Array<IInputSuggestionItem>"}}},icon:{control:{type:"text"},table:{type:{summary:"Array<IIcon>"}}},valueStateMessage:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},openPicker:{description:"Manually opens the suggestions popover, assuming suggestions are enabled. Items must be preloaded for it to open.",table:{category:"methods"},UI5CustomData:{returnValue:{type:{text:"void"}}}},"selection-change":{description:`Fired when the user navigates to a suggestion item via the ARROW keys,
