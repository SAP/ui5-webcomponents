...
>
    ${b||""}
    ${m?m.map(A=>`<ui5-button design="Transparent" slot="action">${A}</ui5-button>`):""}
...
</ui5-timeline>`};l.decorators=[d("22rem")];const s=o.bind({}),U=[{header:r("David Williams","Sales Manager"),default:`<ui5-list separators="Inner" style="margin-block-end: 0.75rem;">
...
>
    ...
    \`;
}`,...(M=(_=l.parameters)==null?void 0:_.docs)==null?void 0:M.source}}};var N,k,C;s.parameters={...s.parameters,docs:{...(N=s.parameters)==null?void 0:N.docs,source:{originalSource:`args => {
  return html\`
<ui5-card
    accessible-name="\${ifDefined(args.accessibleName)}"
    accessible-name-ref="\${ifDefined(args.accessibleNameRef)}"
>
    ...
    \`;
}`,...(C=(k=s.parameters)==null?void 0:k.docs)==null?void 0:C.source}}};const W=["InteractiveHeader","WithList","WithTable","WithTimeline","More"],j=Object.freeze(Object.defineProperty({__proto__:null,InteractiveHeader:i,More:s,WithList:t,WithTable:a,WithTimeline:l,__namedExportsOrder:W,default:L},Symbol.toStringTag,{value:"Module"}));export{j as C,O as c};
