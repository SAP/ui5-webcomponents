import{x as p}from"./lit-element-c5a2b594.js";import{l as o}from"./if-defined-c29cffe1.js";import{o as n}from"./unsafe-html-0ddd83da.js";const d={placement:{control:"select",options:["Start","End","Top","Bottom"]},horizontalAlign:{control:"select",options:["Center","Start","End","Stretch"]},verticalAlign:{control:"select",options:["Center","Top","Bottom","Stretch"]},accessibleRole:{control:"select",options:["None","Dialog","AlertDialog"]},header:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},footer:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},default:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},applyFocus:{description:"Focuses the element denoted by `initialFocus`, if provided,\nor the first focusable element otherwise.",table:{category:"methods"},UI5CustomData:{returnValue:{type:{text:"Promise<void>"},description:"Promise that resolves when the focus is applied"}}},"before-close":{description:"Fired before the component is closed. This event can be cancelled, which will prevent the popup from closing. **This event does not bubble.**",control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"boolean"},name:"escPressed",_ui5privacy:"public",description:"Indicates that `ESC` key has triggered the event."}]}}},$={package:"@ui5/webcomponents",since:"1.0.0-rc.6",tagName:"ui5-popover"};var r=Object.freeze,f=Object.defineProperty,u=(e,c)=>r(f(e,"raw",{value:r(c||e.slice())})),i;const m={title:"Main/Popover",component:"Popover",parameters:{docs:{story:{inline:!1,iframeHeight:"700px"}}},argTypes:d},v=e=>p`<ui5-popover
    ...
    ${n(e.default)}
    ${n(e.footer)}
</ui5-popover>`,t=v.bind({});t.args={headerText:"Newsletter subscription",default:`<div class="popover-content">
...
</div>`};t.decorators=[e=>p(i||(i=u([`<style>
	.popover-content {
		display: flex;
...
<\/script>`])),e())];var a,l,s;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`args => {
...
}`,...(s=(l=t.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const b=["Basic"],x=Object.freeze(Object.defineProperty({__proto__:null,Basic:t,__namedExportsOrder:b,default:m},Symbol.toStringTag,{value:"Module"}));export{x as C,$ as c};
