import{x as r}from"./lit-element-c5a2b594.js";import{l as t}from"./if-defined-c29cffe1.js";import{o}from"./unsafe-html-0ddd83da.js";const d={uploadState:{control:"select",options:["Complete","Error","Ready","Uploading"]},type:{control:"select",options:["Inactive","Active","Detail","Navigation"]},highlight:{control:"select",options:["None","Positive","Critical","Negative","Information"]},default:{control:{type:"text"},table:{type:{summary:"Array<Node>"}}},thumbnail:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},deleteButton:{control:{type:"text"},table:{type:{summary:"Array<IButton>"}}}},b={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.7",tagName:"ui5-upload-collection-item",showDefaultStoryOnly:!0},c={title:"Fiori/Upload Collection/Upload Collection Item",component:"UploadCollectionItem",argTypes:d},s=e=>r`
