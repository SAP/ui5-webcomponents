import{x as i}from"./lit-element-c5a2b594.js";import{l as p}from"./if-defined-c29cffe1.js";import{o as d}from"./unsafe-html-0ddd83da.js";const g={alignContent:{control:"select",options:["Start","End"]},default:{control:{type:"text"},table:{type:{summary:"Array<ToolbarItem>"}}},isOverflowOpen:{description:"Returns if the overflow popup is open.",table:{category:"methods"},UI5CustomData:{returnValue:{type:{text:"boolean"}}}}},C={package:"@ui5/webcomponents",since:"1.17.0",tagName:"ui5-toolbar"},f=()=>i`
...
<\/script>
\`;
}`,...(c=(b=e.parameters)==null?void 0:b.docs)==null?void 0:c.source}}};const T=["Basic","Types","MultipleUI5SelectComponents"],E=Object.freeze(Object.defineProperty({__proto__:null,Basic:o,MultipleUI5SelectComponents:e,Types:w,__namedExportsOrder:T,default:y},Symbol.toStringTag,{value:"Module"}));export{E as C,C as c};
