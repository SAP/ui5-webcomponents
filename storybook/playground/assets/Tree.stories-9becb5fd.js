...
>
    ...
    <ui5-tree-item expanded="" text="Tree 3 (no icon)"> </ui5-tree-item>`};const r=()=>g(s||(s=w([`
...
`]))),n=b.bind({});n.args={header:`
    ...
    <\/script>
\``,...(p=(u=r.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var h,y,f;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:'args => html`<ui5-tree\n    selection-mode="${ifDefined(args.selectionMode)}"\n    no-data-text="${ifDefined(args.noDataText)}"\n    header-text="${ifDefined(args.headerText)}"\n    footer-text="${ifDefined(args.footerText)}"\n    accessible-name="${ifDefined(args.accessibleName)}"\n    accessible-name-ref="${ifDefined(args.accessibleNameRef)}"\n>\n    ${unsafeHTML(args.header)} ${unsafeHTML(args.default)}\n</ui5-tree>`',...(f=(y=n.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};const I=["Basic","DynamicContent","TreeWithCustomItems"],E=Object.freeze(Object.defineProperty({__proto__:null,Basic:i,DynamicContent:r,TreeWithCustomItems:n,__namedExportsOrder:I,default:D},Symbol.toStringTag,{value:"Module"}));export{E as C,M as c};
