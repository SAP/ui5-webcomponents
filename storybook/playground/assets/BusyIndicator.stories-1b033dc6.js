import{x as m}from"./lit-element-c5a2b594.js";import{o as b}from"./unsafe-html-0ddd83da.js";import{l as i}from"./if-defined-c29cffe1.js";import{B as p}from"./BusyIndicatorSize-0335bb2a.js";const v={size:{control:"select",options:["S","M","L"]},textPlacement:{control:"select",options:["Top","Bottom"]},default:{control:{type:"text"},table:{type:{summary:"Array<Node>"}}}},I={package:"@ui5/webcomponents",since:"0.12.0",tagName:"ui5-busy-indicator"};var a=Object.freeze,g=Object.defineProperty,x=(e,y)=>a(g(e,"raw",{value:a(y||e.slice())})),r;const $={title:"Main/Busy Indicator",component:"BusyIndicator",argTypes:v},f=e=>m`<ui5-busy-indicator
    text="${i(e.text)}"
    size="${i(e.size)}"
    ?active="${i(e.active)}"
    delay="${i(e.delay)}"
>
    ${b(e.default)}
</ui5-busy-indicator>`,n=f.bind({});n.args={active:!0,size:p.M};const t=f.bind({});t.args={size:p.M,default:`<ui5-list
