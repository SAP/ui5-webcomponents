...
<div> Media Gallery with seperate image thumbnail:
...
</div>`;var n=Object.freeze,j=Object.defineProperty,D=(e,v)=>n(j(e,"raw",{value:n(v||e.slice())})),m;const w=e=>s`
    <style>
    ...
    ${e()}
`,$={title:"Fiori/Media Gallery",component:"MediaGallery",decorators:[w],argTypes:T};let A=0;const r=e=>s` <ui5-media-gallery
        id="media-gallery-${A++}"
    ...
    <ui5-media-gallery-item layout="Wide">
        ...
        <img
            ...
            alt="SAP Video"
        />
    </ui5-media-gallery-item>`};const i=r.bind({});i.decorators=[e=>s(m||(m=D([`
<style>
