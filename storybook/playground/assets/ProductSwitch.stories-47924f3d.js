import{x as p}from"./lit-element-c5a2b594.js";import{o as h}from"./unsafe-html-0ddd83da.js";const w={default:{control:{type:"text"},table:{type:{summary:"Array<IProductSwitchItem>"}}}},y={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.5",tagName:"ui5-product-switch"};var o=Object.freeze,x=Object.defineProperty,g=(e,m)=>o(x(e,"raw",{value:o(m||e.slice())})),c;const b={title:"Fiori/Product Switch",component:"ProductSwitch",argTypes:w},d=e=>p`
...
`};const t=d.bind({});t.decorators=[e=>p(c||(c=g([`
        <ui5-shellbar
            id="shellbar"
