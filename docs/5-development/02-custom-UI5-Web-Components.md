...
There are 2 steps to do that:
 ...
 3. Get texts from the bundle, according to the currently [configured](../../advanced/configuration) language
 `return Demo.i18nBundle.getText(PLEASE_WAIT);`
...
Next: [Understanding UI5 Web Components Metadata](./03-understanding-components-metadata)
