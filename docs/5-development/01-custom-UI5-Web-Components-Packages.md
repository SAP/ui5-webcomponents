...
Examples:
 ...
 - Modifying `wdio` settings.
	...
	so that we can use `browser.debug()` in our `*.spec.js` files. For more on testing, see [Testing Web Components](./05-testing-ui5-web-components).
...
[Developing Web Components](./02-custom-ui5-web-components) section of the documentation.
...
For more on testing, see our [Testing Web Components](./05-testing-ui5-web-components) section.
...
Next: [Developing Custom UI5 Web Components](./02-custom-UI5-Web-Components)
