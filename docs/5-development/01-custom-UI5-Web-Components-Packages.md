...
Examples:
 ...
 - Modifying `wdio` settings.
	...
	so that we can use `browser.debug()` in our `*.spec.js` files. For more on testing, see [Testing Web Components](./04-testing-UI5-Web-Components.md).
...
Again, to know more about how these files work, you could have a look at the [Developing Web Components](./02-custom-UI5-Web-Components.md#css) section of the documentation.
...
For more on testing, see our [Testing Web Components](./04-testing-UI5-Web-Components.md) section.
