...
**Important:** The get the best development experience, we recommend using the [UI5 Web Components for React](https://github.com/SAP/ui5-webcomponents-react) - React implementation of UI5 Web Components, which overcomes several limitations of React in handling web components in general (explained bellow) and follow the [UI5 Web Components for React Тutorial](https://developers.sap.com/mission.react-spa.html).
