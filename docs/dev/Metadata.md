...
custom type | Extend `@ui5/webcomponents-base/types/DataType.js` | Used mainly for enumerations

#### Examples of prebuilt custom types

Type | Class to use | Description
-----|-------|------
Integer | `@ui5/webcomponents-base/types/Integer.js` | Integer value
CSSSize | `@ui5/webcomponents-base/types/CSSSize.js` | Any valid CSS size definition (`px`, `rem`, etc...)
ValueState | `@ui5/webcomponents-base/types/ValueState.js` | Enumeration with: `None`, `Error`, `Warning`, `Success` values
