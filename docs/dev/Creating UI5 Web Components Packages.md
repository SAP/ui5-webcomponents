...
[Developing Web Components](Developing Web Components.md) section of the documentation.
...
Again, to know more about how these files work, you could have a look at the [Developing Web Components](Developing Web Components.md#css) section of the documentation.
