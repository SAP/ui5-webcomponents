...
and i18n assets respectively. Developers will later import these files in their production applications in order to provide additional themes support
and i18n support. For easier development and testing, these files are also imported in the dev/test bundle `bundle.esm.js` by the initialization script.
