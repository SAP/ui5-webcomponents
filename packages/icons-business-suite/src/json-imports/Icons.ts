...
const loadIconsBundle = async (collection: string): Promise<CollectionData> => {
	...
	if (collection === "business-suite-v1") {
		iconData = (await import("../generated/assets/v1/SAP-icons-business-suite.json")).default as unknown as CollectionData;
	} else {
		iconData = (await import("../generated/assets/v2/SAP-icons-business-suite.json")).default as unknown as CollectionData;
	}
