...
* **framework:** Do not create IE styles with disabled ([#2284](https://github.com/SAP/ui5-webcomponents/issues/2284)) ([abe3b38](https://github.com/SAP/ui5-webcomponents/commit/abe3b38))


### Features

* **framework:** Limited support for campact size on IE ([#2230](https://github.com/SAP/ui5-webcomponents/issues/2230)) ([72bfd84](https://github.com/SAP/ui5-webcomponents/commit/72bfd84))
