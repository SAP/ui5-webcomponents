...
const setCustomElementsScopingSuffix = (suffix: string) => {
	...
	if (hasRegisteredTags()) {
		...
		console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.");
	}
