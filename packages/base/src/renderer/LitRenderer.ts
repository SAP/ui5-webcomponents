...
const litRender = (templateResult: TemplateFunctionResult, container: HTMLElement | DocumentFragment, styleStrOrHrefsArr: StylesDescriptor | undefined, forStaticArea: boolean, options: RenderOptions) => {
