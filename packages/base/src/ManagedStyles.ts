...
const createStyle = (data: StyleData, name: string, value = "", theme = "") => {
...
const updateStyle = (data: StyleData, name: string, value = "", theme = "") => {
	const content = typeof data === "string" ? data : data.content;
	const currentRuntimeIndex = getCurrentRuntimeIndex();
...
const createOrUpdateStyle = (data: StyleData, name: string, value = "", theme = "") => {
