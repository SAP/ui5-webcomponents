...
const displayFailedRegistrations = () => {
	...
	message = `${message}\n\nTo prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/ui5-webcomponents/blob/main/docs/2-advanced/06-scoping.md.`;
