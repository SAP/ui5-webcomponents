...
class OpenUI5Enablement {
    ...
    static enrichBusyIndicatorMethods(UI5ElementPrototype) {
        ...
        UI5ElementPrototype.getDomRef = function getDomRef() {
            ...
            if (this.__isBusy) {
                const busyDomEl = children[0].querySelector(".busy-indicator-wrapper > :not([busy-indicator-before-span]):not(.busy-indicator-overlay):not(.busy-indicator-busy-area)");
