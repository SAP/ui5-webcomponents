...
import {
	...
	SIDE_NAVIGATION_OVERFLOW_ITEM_DESCRIPTION,
...
class SideNavigationItem extends SideNavigationSelectableItemBase {
	...
	get _overflowItemDescription() {
		return SideNavigationItem.i18nBundle.getText(SIDE_NAVIGATION_OVERFLOW_ITEM_DESCRIPTION);
	}
