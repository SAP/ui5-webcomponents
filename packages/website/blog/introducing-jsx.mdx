...
For more implementation details, you can check the [template docs](https://sap.github.io/ui5-webcomponents/docs/development/templates/) and the [PR](https://github.com/UI5/webcomponents/pull/10046)
