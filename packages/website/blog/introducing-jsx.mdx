...
We are proud to announce that the 2.6.0 release of the web components adds support for using [JSX templates](https://github.com/UI5/ui5-webcomponents/pull/10046).
...
For more implementation details, you can check the [template docs](https://sap.github.io/ui5-webcomponents/docs/development/templates/) and the [PR](https://github.com/UI5/ui5-webcomponents/pull/10046)
