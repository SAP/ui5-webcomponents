...
- **Time zone Support**: Date and time components are enhanced to seamlessly adapt to different time zones, ensuring accurate presentation of dates across various regions. : [#8610](https://github.com/SAP/ui5-webcomponents/issues/8610)

- **New Components**: Explore new additions to the UI5 Web Components family, expanding your toolkit for building rich UIs:
    - Text (ui5-text): [#8299](https://github.com/SAP/ui5-webcomponents/pull/8299)
...
- **Components enhancements**: Benefit from enhancements to existing components such:
    ...
    - ui5-link: introduce tooltip property [#8670](https://github.com/SAP/ui5-webcomponents/issues/8670)
    - ui5-message-strip: introduce custom colors [#8757](https://github.com/SAP/ui5-webcomponents/issues/8757)
...
- CSP via adoptedStyleSheets only: [#8496](https://github.com/SAP/ui5-webcomponents/pull/8496)
- Remove jsdoc plugin: [#8518](https://github.com/SAP/ui5-webcomponents/pull/8518)
- Removed `UI5Element#render` method in favour of `UI5Element#renderer`: [#8501](https://github.com/SAP/ui5-webcomponents/pull/8501) 
- Removed all Assets-static.js modules: [#8526](https://github.com/SAP/ui5-webcomponents/pull/8526)
