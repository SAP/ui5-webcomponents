...
const getFullURL = () => {
  return DEVELOPMENT_ENVIRONMENT ? `${BASE_URL}` : `https://kineticjs.github.io${BASE_URL}`
}
...
const config: Config = {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      logo: {
        alt: 'SAP Logo',
        src: 'https://kineticjs.github.io/ui5-webcomponents/img/footer/sap-1920-1440.svg',
        width: 160,
        height: 51,
      },
      links: [
        {
          ...
          items: [
            ...
            //     </a>
            //     <a href="https://kineticjs.github.io/ui5-webcomponents/" target="_blank" rel="noreferrer noopener" aria-label="GitHub">
