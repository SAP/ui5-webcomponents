...
import Input from "../../components/patterns/InputSelectionAssistant/Basic/Basic.md";
import TextArea from "../../components/patterns/TextAreaSelectionAssistant/Basic/Basic.md";
...
The sample demonstrates the usage of <strong>SelectionAssistant</strong> that enhances user interactions by
returning the
