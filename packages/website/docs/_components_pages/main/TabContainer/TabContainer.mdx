...
import NoDefaultSelection from "../../../_samples/main/TabContainer/NoDefaultSelection/NoDefaultSelection.md";
...
No tabs are initially selected and the "noDefaultSelection" property is set. You can go back to the initial state after selecting a tab via API.
<NoDefaultSelection />
