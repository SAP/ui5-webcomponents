...
import CustomIcon from "../../../_samples/main/Input/CustomIcon/CustomIcon.md";
...
### Custom Icon Styling
Custom icons added in the icon slot of the ui5-input can reuse the input icon styling with the help of our Common CSS layer.
<br/>
**Note:** This solution works if your application is using a framework or bundle that supports CSS modules.
