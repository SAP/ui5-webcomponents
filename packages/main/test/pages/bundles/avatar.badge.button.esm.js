...
const block0 = (context) => { return html`<div class="ui5-avatar-root">${ context.image ? block1(context) : block2(context) }</div>`; };
const block1 = (context) => { return html`<span class="ui5-avatar-img" style="background-image: url(${ifDefined(context.image)})" role="img" aria-label="${ifDefined(context.accessibleNameText)}"></span>`; };
const block2 = (context) => { return html`${ context.icon ? block3(context) : block4(context) }`; };
const block3 = (context) => { return html`<ui5-icon class="ui5-avatar-icon" name="${ifDefined(context.icon)}" accessible-name="${ifDefined(context.accessibleNameText)}"></ui5-icon>`; };
const block4 = (context) => { return html`${ context.initials ? block5(context) : undefined }`; };
const block5 = (context) => { return html`<span class="ui5-avatar-initials">${ifDefined(context.validInitials)}</span>`; };

const AVATAR_TOOLTIP = {key: "AVATAR_TOOLTIP", defaultText: "Avatar"};const BADGE_DESCRIPTION = {key: "BADGE_DESCRIPTION", defaultText: "Badge"};const BUTTON_ARIA_TYPE_ACCEPT = {key: "BUTTON_ARIA_TYPE_ACCEPT", defaultText: "Positive Action"};const BUTTON_ARIA_TYPE_REJECT = {key: "BUTTON_ARIA_TYPE_REJECT", defaultText: "Negative Action"};const BUTTON_ARIA_TYPE_EMPHASIZED = {key: "BUTTON_ARIA_TYPE_EMPHASIZED", defaultText: "Emphasized"};
...
const block0$2 = (context) => { return html`<div class="ui5-badge-root" dir="${ifDefined(context.rtl)}">${ context.hasIcon ? block1$2() : undefined }${ context.hasText ? block2$1() : undefined }<span class="ui5-hidden-text">${ifDefined(context.badgeDescription)}</span></div>`; };
const block1$2 = (context) => { return html`<slot name="icon"></slot>`; };
const block2$1 = (context) => { return html`<label class="ui5-badge-text"><bdi><slot></slot></bdi></label>`; };
...
//# sourceMappingURL=avatar.badge.button.esm.js.map
