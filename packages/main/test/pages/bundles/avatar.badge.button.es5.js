(function (exports) {
    ...
    */
    ...
    function _templateObject6() {
      var data = _taggedTemplateLiteral(["<span class=\"ui5-avatar-initials\">", "</span>"]);
    ...
    function _templateObject4() {
      var data = _taggedTemplateLiteral(["<ui5-icon class=\"ui5-avatar-icon\" name=\"", "\" accessible-name=\"", "\"></ui5-icon>"]);
    ...
    function _templateObject2() {
      var data = _taggedTemplateLiteral(["<span class=\"ui5-avatar-img\" style=\"background-image: url(", ")\" role=\"img\" aria-label=\"", "\"></span>"]);
    ...
    function _templateObject$1() {
      var data = _taggedTemplateLiteral(["<div class=\"ui5-avatar-root\">", "</div>"]);
    ...
    var block0 = function block0(context) {
      return html(_templateObject$1(), context.image ? block1(context) : block2(context));
    };

    var block1 = function block1(context) {
      return html(_templateObject2(), ifDefined(context.image), ifDefined(context.accessibleNameText));
    };

    var block2 = function block2(context) {
      return html(_templateObject3(), context.icon ? block3(context) : block4(context));
    };

    var block3 = function block3(context) {
      return html(_templateObject4(), ifDefined(context.icon), ifDefined(context.accessibleNameText));
    };

    var block4 = function block4(context) {
      return html(_templateObject5(), context.initials ? block5(context) : undefined);
    };

    var block5 = function block5(context) {
      return html(_templateObject6(), ifDefined(context.validInitials));
    };
    ...
    var AvatarCss = ":host(:not([hidden])){display:inline-block;box-sizing:border-box}:host(:not([hidden]).ui5_hovered){opacity:.7}:host{height:3rem;width:3rem;border-radius:50%;outline:none;color:var(--sapContent_ImagePlaceholderForegroundColor)}:host([shape=Square]){border-radius:.25rem}:host([shape=Square]) .ui5-avatar-root{border-radius:.25rem}:host([shape=Square]) .ui5-avatar-img{border-radius:.25rem}:host([size=XS]){height:2rem;width:2rem;font-size:.75rem}:host([size=S]){height:3rem;width:3rem;font-size:1.125rem}:host([size=M]){height:4rem;width:4rem;font-size:1.625rem}:host([size=L]){height:5rem;width:5rem;font-size:2rem}:host([size=XL]){height:7rem;width:7rem;font-size:2.75rem}:host .ui5-avatar-icon{height:1.5rem;width:1.5rem}:host([size=XS]) .ui5-avatar-icon{height:1rem;width:1rem}:host([size=S]) .ui5-avatar-icon{height:1.5rem;width:1.5rem}:host([size=M]) .ui5-avatar-icon{height:2rem;width:2rem}:host([size=L]) .ui5-avatar-icon{height:2.5rem;width:2.5rem}:host([size=XL]) .ui5-avatar-icon{height:3rem;width:3rem}:host(:not([image])){background-color:var(--sapAccentColor6)}:host([background-color=Accent1]){background-color:var(--sapAccentColor1)}:host([background-color=Accent2]){background-color:var(--sapAccentColor2)}:host([background-color=Accent3]){background-color:var(--sapAccentColor3)}:host([background-color=Accent4]){background-color:var(--sapAccentColor4)}:host([background-color=Accent5]){background-color:var(--sapAccentColor5)}:host([background-color=Accent6]){background-color:var(--sapAccentColor6)}:host([background-color=Accent7]){background-color:var(--sapAccentColor7)}:host([background-color=Accent8]){background-color:var(--sapAccentColor8)}:host([background-color=Accent9]){background-color:var(--sapAccentColor9)}:host([background-color=Accent10]){background-color:var(--sapAccentColor10)}:host([background-color=Placeholder]){background-color:var(--sapContent_ImagePlaceholderBackground)}:host(:not([image])) .ui5-avatar-icon{color:inherit}:host([image-fit-type=Contain]) .ui5-avatar-img{background-size:contain}.ui5-avatar-root{display:flex;align-items:center;justify-content:center}.ui5-avatar-img,.ui5-avatar-root{height:100%;width:100%;border-radius:50%}.ui5-avatar-img{background-repeat:no-repeat;background-position:50%;background-size:cover}.ui5-avatar-initials{color:inherit}";
    ...
    /*#__PURE__*/
    function (_DataType) {
      _inherits(AvatarSize, _DataType);

      function AvatarSize() {
        _classCallCheck(this, AvatarSize);

        return _possibleConstructorReturn(this, _getPrototypeOf(AvatarSize).apply(this, arguments));
      }

      _createClass(AvatarSize, null, [{
        key: "isValid",
        value: function isValid(value) {
    ...
    /*#__PURE__*/
    function (_DataType) {
      _inherits(AvatarShape, _DataType);

      function AvatarShape() {
        _classCallCheck(this, AvatarShape);

        return _possibleConstructorReturn(this, _getPrototypeOf(AvatarShape).apply(this, arguments));
      }

      _createClass(AvatarShape, null, [{
        key: "isValid",
        value: function isValid(value) {
    ...
    /*#__PURE__*/
    function (_DataType) {
      _inherits(AvatarFitType, _DataType);

      function AvatarFitType() {
        _classCallCheck(this, AvatarFitType);

        return _possibleConstructorReturn(this, _getPrototypeOf(AvatarFitType).apply(this, arguments));
      }

      _createClass(AvatarFitType, null, [{
        key: "isValid",
        value: function isValid(value) {
    ...
    /*#__PURE__*/
    function (_DataType) {
      _inherits(AvatarBackgroundColor, _DataType);

      function AvatarBackgroundColor() {
        _classCallCheck(this, AvatarBackgroundColor);

        return _possibleConstructorReturn(this, _getPrototypeOf(AvatarBackgroundColor).apply(this, arguments));
      }

      _createClass(AvatarBackgroundColor, null, [{
        key: "isValid",
        value: function isValid(value) {
    ...
    function (_UI5Element) {
      ...
      function Avatar() {
        ...
        _this = _possibleConstructorReturn(this, _getPrototypeOf(Avatar).call(this));
        _this.i18nBundle = getI18nBundle("@ui5/webcomponents");
        return _this;
      }
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return Promise.all([fetchI18nBundle("@ui5/webcomponents"), Icon.define()]);
    ...
    function _templateObject$3() {
      var data = _taggedTemplateLiteral(["<div class=\"ui5-badge-root\" dir=\"", "\">", "", "<span class=\"ui5-hidden-text\">", "</span></div>"]);
    ...
    var block0$2 = function block0(context) {
      return html(_templateObject$3(), ifDefined(context.rtl), context.hasIcon ? block1$2() : undefined, context.hasText ? block2$1() : undefined, ifDefined(context.badgeDescription));
    };
    ...
    registerThemeProperties("@ui5/webcomponents-theme-base", "sap_fiori_3", defaultThemeBase);
    registerThemeProperties("@ui5/webcomponents", "sap_fiori_3", defaultTheme);
    var badgeCss = ".ui5-hidden-text{position:absolute;clip:rect(1px,1px,1px,1px);user-select:none;left:0;top:0}:host(:not([hidden])){display:inline-block;height:1.125em;min-width:1.125em;max-width:100%;padding:0 .625em;color:var(--sapTextColor);background:var(--sapLegendBackgroundColor1);border:solid 1px var(--sapLegendColor1);border-radius:1.125em;box-sizing:border-box;font-family:var(--sapFontFamily);text-align:center}:host([__has-icon]){padding:0 .3125em}::slotted(ui5-icon){width:.75em;height:.75em}ui5-badge ui5-icon[slot=icon]{display:flex}:host([__has-icon]) .ui5-badge-text{padding-left:.1875em}:host([__has-icon]) .ui5-badge-root[rtl] .ui5-badge-text{padding-right:.1875em}:host([color-scheme=\"1\"]){background-color:var(--sapLegendBackgroundColor1);border-color:var(--sapLegendColor1)}:host([color-scheme=\"2\"]){background-color:var(--sapLegendBackgroundColor2);border-color:var(--sapLegendColor2)}:host([color-scheme=\"3\"]){background-color:var(--sapLegendBackgroundColor3);border-color:var(--sapLegendColor3)}:host([color-scheme=\"4\"]){background-color:var(--sapLegendBackgroundColor4);border-color:var(--sapLegendColor4)}:host([color-scheme=\"5\"]){background-color:var(--sapLegendBackgroundColor5);border-color:var(--sapLegendColor5)}:host([color-scheme=\"6\"]){background-color:var(--sapLegendBackgroundColor6);border-color:var(--sapLegendColor6)}:host([color-scheme=\"7\"]){background-color:var(--sapLegendBackgroundColor7);border-color:var(--sapLegendColor7)}:host([color-scheme=\"8\"]){background-color:var(--sapLegendBackgroundColor8);border-color:var(--sapLegendColor8)}:host([color-scheme=\"9\"]){background-color:var(--sapLegendBackgroundColor9);border-color:var(--sapLegendColor9)}:host([color-scheme=\"10\"]){background-color:var(--sapLegendBackgroundColor10);border-color:var(--sapLegendColor10)}.ui5-badge-root{display:flex;align-items:center;width:100%;height:100%;box-sizing:border-box}.ui5-badge-text{width:100%;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;text-transform:uppercase;letter-spacing:.0125em;font-size:var(--ui5-badge-font-size)}";
    ...
    var block0$3 = function block0(context) {
      return html(_templateObject$4(), context.disabled, ifDefined(context.rtl), context._onfocusout, context._onfocusin, context._onclick, context._onmousedown, context._onmouseup, context._onkeydown, context._onkeyup, ifDefined(context.tabIndexValue), ifDefined(context.accInfo.ariaExpanded), ifDefined(context.accInfo.ariaControls), ifDefined(context.accInfo.ariaHaspopup), ifDefined(context.ariaLabelText), ifDefined(context.accInfo.title), context.icon ? block1$3(context) : undefined, ifDefined(context._id), context.hasButtonType ? block2$2(context) : undefined);
    };

    var block1$3 = function block1(context) {
      return html(_templateObject2$3(), ifDefined(context.icon), ifDefined(context.iconOnly));
    };

    var block2$2 = function block2(context) {
      return html(_templateObject3$3(), ifDefined(context.buttonTypeText));
    };
...
//# sourceMappingURL=avatar.badge.button.es5.js.map
