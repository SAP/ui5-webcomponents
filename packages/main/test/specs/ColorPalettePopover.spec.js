...
describe("ColorPalette interactions", () => {
	...
	it("Test if focusing first element works on initial open", async () => {
		...
		assert.ok(await defaultButton.matchFocus(),  "The first element is focused");
	...
	it("Test if keyboard navigation on elements works", async () => {
		...
		assert.ok(await moreColorsButton.matchFocus(),  "Button 'MoreColors' is focused");
	...
	it("Tests navigation with recent colors", async () => {
		...
		assert.ok(await moreColorsButton.matchFocus(),  "Check if more colors button is focused");
