...
describe("RTL", () => {
	it("language forces RTL, if RTL not specified", async () => {
		await browser.url(`http://localhost:${PORT}/test-resources/pages/Switch.html?sap-ui-language=he`);
	...
	it("config forces RTL", async () => {
		await browser.url(`http://localhost:${PORT}/test-resources/pages/Switch.html?sap-ui-rtl=true`);
	...
	it("config unsets RTL, although rtl language is used", async () => {
		await browser.url(`http://localhost:${PORT}/test-resources/pages/Switch.html?sap-ui-rtl=false&sap-ui-language=he`);
