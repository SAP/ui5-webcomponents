...
describe("Card general interaction", () => {
	...
	it("Tests internal aria-labelledby labeling", () => {
		...
		const EXPECTED_ARIA_LABELLEDBY_CARD = `${card1Id}-titleText ${card1Id}-desc`;
		const EXPECTED_ARIA_LABELLEDBY_HEADER = `${card1Id}-subtitleText ${card1Id}-status ${card1Id}-avatar`;
		const EXPECTED_ARIA_LABELLEDBY_CARD2 = `${card2Id}-titleText ${card2Id}-desc`;
		const EXPECTED_ARIA_LABELLEDBY_HEADER2 = `${card2Id}-subtitleText`;
