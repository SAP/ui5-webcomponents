...
describe("Popover general interaction", () => {
	...
	it("tests initial focus", async () => {
		...
		assert.ok(await focusedButton.matchesFocus(), "The button is focused.");
	...
	it("tests focus trapping using TAB", async () => {
		...
		assert.ok(await ff.matchesFocus(), "The first focusable element is focused.");

		// list
		await browser.keys("Tab");

		assert.notOk(await ff.matchesFocus(), "The first focusable element is focused.");
