	...
	describe("Rendering", () => {
		it("tests single row action", () => {
			mountTable(1, `
				...
				<ui5-table-row>
					<ui5-table-row-action slot="actions" icon="add" text="Add" disabled></ui5-table-row-action>
				</ui5-table-row>
				<ui5-table-row>
					<ui5-table-row-action slot="actions" icon="add" text="Add" hidden></ui5-table-row-action>
				</ui5-table-row>
				<ui5-table-row>
			...
			cy.get("@row2").find("[icon=add]").shadow().find("ui5-button").should("have.attr", "disabled");
			cy.get("@row3").find("[icon=add]").should("have.css", "display", "block");
			cy.get("@row4").find("ui5-table-row-action-navigation").shadow().find("ui5-icon").should("have.attr", "name", "navigation-right-arrow");
			cy.get("@row5").find("ui5-table-row-action-navigation").shadow().find("ui5-button").should("have.attr", "icon", "navigation-right-arrow");
		...
		it("tests multiple row actions - all visible", () => {
			mountTable(2, `
				<ui5-table-row>
					...
					<ui5-table-row-action slot="actions" icon="delete" text="Delete" disabled></ui5-table-row-action>
				</ui5-table-row>
			`);
			...
			cy.get("@menuItems").eq(2).should("have.attr", "text", "Delete").and("have.attr", "icon", "delete").and("have.attr", "disabled");
			...
			cy.get("@menuItems").eq(1).should("have.attr", "text", "Delete").and("have.attr", "icon", "delete").and("have.attr", "disabled");
			cy.get("@menuItems").eq(0).ui5MenuItemClick();
		...
		it("tests that hidden actions occupy space for alignment", () => {
			mountTable(3, `
				<ui5-table-row>
					<ui5-table-row-action slot="actions" icon="add" text="Add"></ui5-table-row-action>
					<ui5-table-row-action slot="actions" icon="edit" text="Edit" hidden></ui5-table-row-action>
		...
		it("tests that avoiding overflow is more important than aligment", () => {
			mountTable(3, `
				<ui5-table-row>
					...
					<ui5-table-row-action slot="actions" icon="delete" text="Delete"></ui5-table-row-action>
					<ui5-table-row-action slot="actions" icon="share" text="Share" hidden></ui5-table-row-action>
				</ui5-table-row>
			`);
		...
		it("tests that the aligment of navigation is more important than avoiding overflow", () => {
			mountTable(3, `
				<ui5-table-row>
					<ui5-table-row-action-navigation slot="actions" hidden></ui5-table-row-action-navigation>
					<ui5-table-row-action slot="actions" icon="add" text="Add"></ui5-table-row-action>
					<ui5-table-row-action slot="actions" icon="edit" text="Edit"></ui5-table-row-action>
					<ui5-table-row-action slot="actions" icon="delete" text="Delete"></ui5-table-row-action>
				</ui5-table-row>
