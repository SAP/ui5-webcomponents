...
const transformLine = line => {
	...
	// element.*
	line = line.replaceAll(/([a-zA-Z0-9_\[\]]+)\.(\$|\$\$|isClickable|getTagName|getText|setText|getValue|getProperty|setValue|setProperty|getAttribute|setAttribute|removeAttribute|click|doubleClick|keys|shadow\$|shadow\$\$|isExisting|isDisplayed|isDisplayedInViewport|isFocused|isFocusedDeep|hasClass|moveTo|scrollIntoView|getSize|getHTML|dragAndDrop|getCSSProperty|getLocation)\(/g, "await $1.$2(");
