...
class RangeSlider extends SliderBase implements IFormInputElement {
	...
	*/
	...
	_updateInputValue() {
		...
		this._inputStartValue = parseFloat(startValueInput.value);
		this._inputEndValue = parseFloat(endValueInput.value);
