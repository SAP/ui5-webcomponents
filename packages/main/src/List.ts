 ...
 * (such as a checkbox or radio button) within the list item is directly clicked.
 * In these scenarios, use the `selection-change` event to monitor when an item is selected or deselected.
