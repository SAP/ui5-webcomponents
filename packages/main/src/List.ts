...
class List extends UI5Element {
  ...
  onItemClick!: FireEventFn<{ item: HTMLElement }>;
  ...
  onItemClose!: FireEventFn<{ item: HTMLElement }>;
  ...
  onItemToggle!: FireEventFn<{ item: HTMLElement }>;
  ...
  onItemDelete!: FireEventFn<{ item: HTMLElement }>;
  ...
  onItemFocused!: FireEventFn<{ item: HTMLElement }>;
...
*/
  ...
  _onItemClose(e: CustomEvent<CloseEventDetail>) {
	this.onItemClose({item: e.detail.item});
  }

  _onItemToggle(e: CustomEvent<ToggleEventDetail>) {
	this.onItemToggle({item: e.detail.item});
  }
