...
class List extends UI5Element {
	...
	get showDragGhost() {
		return this.draggedItemsCount > 1;
	}

	get dragGhostText() {
		return List.i18nBundle.getText(LIST_DRAG_GHOST_TEXT, this.draggedItemsCount);
	}
	...
	*/
	...
	onItemDragStart(e: CustomEvent<DragStartEventDetail>) {
