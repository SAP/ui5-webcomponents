...
class DateTimePicker extends DatePicker {
	...
	getSelectedDateTime() {
		const selectedDate = this.getFormat().parse(this._calendarSelectedDates[0], undefined, undefined) as Date;
		const selectedTime = this.getFormat().parse(this._timeSelectionValue, undefined, undefined) as Date;
		if (selectedTime) {
