	...
	get classes(): ClassMap {
		return {
			popover: {
				...
				"ui5-suggestions-popover-with-value-state-header-phone": this._isPhone && this.hasValueStateMessage,
				"ui5-suggestions-popover-with-value-state-header": !this._isPhone && this.hasValueStateMessage,
			},
			popoverValueState: {
