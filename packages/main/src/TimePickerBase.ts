...
class TimePickerBase extends UI5Element {
	...
	onInput!: FireEventFn<TimeSelectionChangeEventDetail>;
	/**
	...
	/**
	 * Formats a JavaScript date object into a string representing a locale date and time
	 * according to the <code>formatPattern</code> property of the TimePicker instance
	 * @param {object} date A JavaScript date object to be formatted as string
	 * @public
	 * @method
