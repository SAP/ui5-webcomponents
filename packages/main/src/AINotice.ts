...
import { AINOTICE_ATTRIBUTION_TEXT } from "./generated/i18n/i18n-defaults.js";
...
class AINotice extends UI5Element {
    ...
    get attributionTextValue() {
        return AINotice.i18nBundle.getText(AINOTICE_ATTRIBUTION_TEXT);
    }
    ...
    resizeWidth() {
        ...
        const attributionText = this.shadowRoot?.querySelector(".sapMLnkText") as HTMLElement;
