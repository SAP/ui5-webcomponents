...
import type { IIcon, IInputSuggestionItem, IInput } from "./Interfaces.js";
// Templates
...
class Input extends UI5Element implements SuggestionComponent, IFormElement, IInput {
	/**
	 ...
	 * @type {IInputSuggestionItem | null}
	 * @default null
	 * @public
	 */
	get previewItem() {
