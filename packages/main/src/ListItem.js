...
const metadata = {
	...
	slots: /** @lends sap.ui.webcomponents.main.ListItem.prototype */ {
		...
		/**
		 * Defines a <code>ui5-button</code> which serves as a replacement of
		 * the delete button generated by default.
		 * Its placement is set to match ListItem's default delete button.
		 *
