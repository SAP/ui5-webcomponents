...
class ColorPicker extends UI5Element {
	...
	_applySliderStyles() {
		...
		const hueProgressSlider = hueSlider.querySelector(".ui5-slider-progress-container"),
			...
			alphaProgressSliderColor = this.effectiveDir === "rtl" ? "right" : "left";
		...
		alphaProgressSlider.style.marginTop = this.effectiveDir === "rtl" ? "10px" : "-10px";
		...
		hueProgressSlider.style.backgroundImage = `-webkit-linear-gradient(${alphaProgressSliderColor}, #f00, #ff0, #0f0, #0ff, #00f, #f0f, #f00)`;
		hueProgressSlider.style.backgroundImage = `-moz-linear-gradient(${alphaProgressSliderColor}, #f00, #ff0, #0f0, #0ff, #00f, #f0f, #f00)`;
		hueProgressSlider.style.backgroundImage = `-ms-linear-gradient(${alphaProgressSliderColor}, #f00, #ff0, #0f0, #0ff, #00f, #f0f, #f00)`;
		hueProgressSlider.style.backgroundImage = `linear-gradient(${alphaProgressSliderColor}, #f00, #ff0, #0f0, #0ff, #00f, #f0f, #f00)`;
		hueProgressSlider.style.backgroundColor = "none";

		// ui5-slider.ui5-color-picker-alpha-slider::part(progress-container)
		alphaProgressSlider.style.backgroundImage = `-webkit-linear-gradient(${alphaProgressSliderColor}, #fff, #979797)`;
		alphaProgressSlider.style.backgroundImage = `-moz-linear-gradient(${alphaProgressSliderColor}, #fff, #979797)`;
		alphaProgressSlider.style.backgroundImage = `-ms-linear-gradient(${alphaProgressSliderColor}, #fff, #979797)`;
		alphaProgressSlider.style.backgroundImage = `linear-gradient(${alphaProgressSliderColor}, #fff, #979797)`;
	...
	get styles() {
		const direction = this.effectiveDir === "rtl" ? "right" : "left";
		return {
			mainColor: {
