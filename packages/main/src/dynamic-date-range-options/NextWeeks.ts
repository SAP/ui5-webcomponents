...
/**
 * Next X Weeks option for Dynamic Date Range
 * @public
 * @since 2.12.0
 */
class NextWeeks implements IDynamicDateRangeOption {
	template: JsxTemplate;
	timeUnit = DynamicDateRangeTimeUnit.Weeks;
	...
	get text(): string {
		return DynamicDateRange.i18nBundle.getText(DYNAMIC_DATE_RANGE_NEXT_WEEKS_TEXT);
	}
...
DynamicDateRange.register("NEXTWEEKS", NextWeeks);
