...
/**
 * Next X Years option for Dynamic Date Range
 * @public
 * @since 2.12.0
 */
class NextYears implements IDynamicDateRangeOption {
	...
	get text(): string {
		return DynamicDateRange.i18nBundle.getText(DYNAMIC_DATE_RANGE_NEXT_YEARS_TEXT);
	}
...
DynamicDateRange.register("NEXTYEARS", NextYears);
