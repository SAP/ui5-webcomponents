...
/**
 * Next X Months option for Dynamic Date Range
 * @public
 * @since 2.12.0
 */
class NextMonths implements IDynamicDateRangeOption {
	template: JsxTemplate;
	timeUnit = DynamicDateRangeTimeUnit.Months;
	...
	get text(): string {
		return DynamicDateRange.i18nBundle.getText(DYNAMIC_DATE_RANGE_NEXT_MONTHS_TEXT);
	}
...
DynamicDateRange.register("NEXTMONTHS", NextMonths);

export default NextMonths;
