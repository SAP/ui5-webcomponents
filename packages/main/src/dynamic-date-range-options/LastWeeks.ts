...
/**
 * Last X Weeks option for Dynamic Date Range
 * @public
 * @since 2.12.0
 */
class LastWeeks implements IDynamicDateRangeOption {
	...
	get text(): string {
		return DynamicDateRange.i18nBundle.getText(DYNAMIC_DATE_RANGE_LAST_WEEKS_TEXT);
	}
...
DynamicDateRange.register("LASTWEEKS", LastWeeks);
