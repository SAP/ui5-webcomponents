...
/**
 * Next X Days option for Dynamic Date Range
 * @public
 * @since 2.12.0
 */
class NextDays implements IDynamicDateRangeOption {
	...
	get text(): string {
		return DynamicDateRange.i18nBundle.getText(DYNAMIC_DATE_RANGE_NEXT_DAYS_TEXT);
	}
...
DynamicDateRange.register("NEXTDAYS", NextDays);
