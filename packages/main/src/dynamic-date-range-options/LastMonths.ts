...
/**
 * Last X Months option for Dynamic Date Range
 * @public
 * @since 2.12.0
 */
class LastMonths implements IDynamicDateRangeOption {
	...
	get text(): string {
		return DynamicDateRange.i18nBundle.getText(DYNAMIC_DATE_RANGE_LAST_MONTHS_TEXT);
	}
...
DynamicDateRange.register("LASTMONTHS", LastMonths);
