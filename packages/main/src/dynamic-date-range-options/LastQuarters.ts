...
/**
 * Last X Quarters option for Dynamic Date Range
 * @public
 * @since 2.12.0
 */
class LastQuarters implements IDynamicDateRangeOption {
	...
	get text(): string {
		return DynamicDateRange.i18nBundle.getText(DYNAMIC_DATE_RANGE_LAST_QUARTERS_TEXT);
	}
...
DynamicDateRange.register("LASTQUARTERS", LastQuarters);

export default LastQuarters;
