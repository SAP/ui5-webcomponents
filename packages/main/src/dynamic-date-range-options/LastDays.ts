...
/**
 * Last X Days option for Dynamic Date Range
 * @public
 * @since 2.12.0
 */
class LastDays implements IDynamicDateRangeOption {
	template: JsxTemplate;
	timeUnit = DynamicDateRangeTimeUnit.Days;
	...
	get text(): string {
		return DynamicDateRange.i18nBundle.getText(DYNAMIC_DATE_RANGE_LAST_DAYS_TEXT);
	}
...
DynamicDateRange.register("LASTDAYS", LastDays);
