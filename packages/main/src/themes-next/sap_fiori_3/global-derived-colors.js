const derivations = {
	...
	"--sapUiCalloutShadow": () => any({static: "0px 6px 12px 0px", var: "--sapUiContentShadowColorFade30"}),
	...
	"--sapUiShadowHeader": () => any({static: "0 1px 0.5rem 0", var: "--sapUiContentShadowColorFade5"}),
