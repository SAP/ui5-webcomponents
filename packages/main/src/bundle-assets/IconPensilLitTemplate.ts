...
function block0 (this: any, context: UI5Element, tags: string[], suffix: string | undefined) { 
	return html`<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">${blockSVG1.call(this, context, tags, suffix)}</svg>`;
}
...
export default function IconPensilLitTemplate(this: any) { 
	return block0.call(this, this, (this.constructor as typeof UI5Element).tagsToScope, getCustomElementsScopingSuffix()); 
}