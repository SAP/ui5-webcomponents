...
sap.ui.define([
	...
	// ES6 handles lazy dependencies and sap.ui.requireSync breaks!
	...
	var Configuration = BaseObject.extend("sap.ui.core.Configuration", /** @lends sap.ui.core.Configuration.prototype */ {
		...
		getCalendarType :  function() {
			...
			if ( !CalendarType ) {
				...
				// ES6 [!] Error: Illegal reassignment to import 'CalendarType'
				// CalendarType = sap.ui.require("sap/ui/core/library").CalendarType;
			}
			if ( !LocaleData ) {
				// ES6 [!] Error: Illegal reassignment to import 'LocaleData'
