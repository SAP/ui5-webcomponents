...
sap.ui.define([
	...
	var oCfgData = window["sap-ui-config"] = (function() {
		...
		if (oCfg instanceof window.HTMLElement) {
			// the script tag with type application/json and id="sap-ui-config" puts it on window with the same name as the id
			// if it was assigned to window["sap-ui-config"] by the app, it would not be an HTMLElement
			oCfg = undefined;
		}
