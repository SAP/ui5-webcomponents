...
allThemes.forEach(theme => {
	buildThemesCommands[theme] = `nps build.themes.copy_${theme}_vars build.themes.copy_${theme}_vars_internal build.themes.copy_${theme}_bundle`;
	...
	buildThemesCommands[`copy_${theme}_vars_internal`] = `copy-and-watch "src/themes/${theme.replace("sap_horizon_exp", "sap_horizon")}/css_variables.css" dist/themes/${theme}/`;
