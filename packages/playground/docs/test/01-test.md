...
parent: Test
nav_order: 1
permalink: /playground/test/test/
---
...
[TEST LINK](../test2#syntax_at)

[TEST LINK](../../development/understanding-hbs-templates)

[TEST LINK](../../development/understanding-hbs-templates#syntax_at)
...
You should render each slot, defined in your component's metadata (see [Understanding UI5 Web Components Metadata](../understanding-components-metadata)), somewhere in the `.hbs` template.
...
The `individualSlots` slot metadata configuration setting (see [Understanding UI5 Web Components Metadata](../understanding-components-metadata)) allows you to have a separate physical slot for each child belonging to a certain slot.
