...
- [List of all public module imports](https://sap.github.io/ui5-webcomponents/main/playground/docs/public-module-imports/)
- [How to use](https://sap.github.io/ui5-webcomponents/main/playground/docs/how-to-use/)
- [How to configure](https://sap.github.io/ui5-webcomponents/main/playground/docs/configuration/)
...
**A:** Yes, for more information see [Creating a custom UI5 Web Components package](https://github.com/SAP/ui5-webcomponents/blob/main/docs/dev/Creating%20UI5%20Web%20Components%20Packages.md)


**Q: How big is the runtime?**

**A:** Currently on main branch, a simple working Web Component (```ui5-label```) and its dependencies equals to around 22K gzipped. 
