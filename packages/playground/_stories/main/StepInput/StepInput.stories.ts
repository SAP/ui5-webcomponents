...
<ui5-step-input
	...
	>${unsafeHTML(args.valueStateMessage)}</ui5-step-input
>`;
...
Design.storyName = "With Value State";
Design.args = {
	value: 5,
...
MinMax.storyName = "With Min, Max and Step Values";
MinMax.args = {
	value: 0,
	min: -100,
	max: 100,
...
ValuePrecision.storyName = "With Value Precision";
ValuePrecision.args = {
	value: 5,
	min: 0,
	max: 10,
