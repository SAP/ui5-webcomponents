...
const getScripts = (options) => {
	...
	const scripts = {
		...
		testCEM: `cem analyze --config  "${require.resolve("@ui5/webcomponents-tools/components-package/custom-elements-manifest.config.mjs")}"`,
		prepare: {
		...
		generateAPI: {
			default: "nps generateAPI.prepare generateAPI.preprocess generateAPI.jsdoc generateAPI.cleanup testCEM",
