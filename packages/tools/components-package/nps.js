...
const getScripts = (options) => {
	...
	const scripts = {
		...
		generateAPI: {
			default: `nps ${ tsOption ? "generateAPI.generateCEM generateAPI.validateCEM" : "generateAPI.prepare generateAPI.preprocess generateAPI.jsdoc generateAPI.cleanup generateAPI.prepareManifest 'generateAPI.validateCEM --external-only'"}`,
