...
function block0(context, tags, suffix) { return html `<div class="ui5-media-gallery-item-root" tabindex="${ifDefined(this.effectiveTabIndex)}" data-sap-focus-ref @keydown="${this._onkeydown}" @keyup="${this._onkeyup}" role="${ifDefined(this._role)}"><div class="ui5-media-gallery-item-mask-layer"></div><div class="ui5-media-gallery-item-wrapper" style="${styleMap(this.styles.wrapper)}">${this._showBackgroundIcon ? block1.call(this, context, tags, suffix) : undefined}${this._useContent ? block2.call(this, context, tags, suffix) : undefined}${this._useThumbnail ? block3.call(this, context, tags, suffix) : undefined}</div></div>`; }
